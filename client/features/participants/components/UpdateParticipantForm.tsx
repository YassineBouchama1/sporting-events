...
type CreateParticipantFormType = z.infer<typeof createParticipantSchema>;
...
const UpdateParticipantForm = () => {
    ...
    const {
        ...
        reset,
        formState: { errors },
    } = useForm<CreateParticipantFormType>({
        resolver: zodResolver(createParticipantSchema),
    });


    // hanlde submit action
    const onSubmit = async (data: CreateParticipantFormType) => {
